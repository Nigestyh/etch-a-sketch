...
- Color selection from a dropdown menu
- Rainbow mode with randomly generated colors
- Eraser tool for removing drawn cells
...
5. Select Rainbow mode for random colors
